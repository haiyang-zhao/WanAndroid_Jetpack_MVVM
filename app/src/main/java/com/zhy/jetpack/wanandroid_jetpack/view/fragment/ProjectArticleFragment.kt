...
import com.zhy.jetpack.wanandroid_jetpack.view.adapter.ProjectAdapter
import com.zhy.jetpack.wanandroid_jetpack.viewmodel.request.RequestProjectArticleViewModel
import com.zhy.jetpack.wanandroid_jetpack.viewmodel.request.RequestWXArticleViewModel
import com.zhy.jetpack.wanandroid_jetpack.viewmodel.state.ProjectArticleViewModel
...
class ProjectArticleFragment : BaseFragment<ProjectArticleViewModel, IncludeListBinding>() {

    private val requestViewModel by viewModels<RequestProjectArticleViewModel>()
    private val articleAdapter by lazy { ProjectAdapter(mutableListOf()) }
    ...
    companion object {
        fun newInstance(id: Int): ProjectArticleFragment {
